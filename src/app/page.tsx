    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-xl p-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800">Alohabake&cafe Kaka'ako</h1>
          <p className="text-slate-500 text-sm mt-1">会員ログイン</p>
        </div>
        ...
        <form onSubmit={submitEmail} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-slate-800 text-white font-semibold py-3.5 rounded-2xl hover:bg-slate-700 transition-colors disabled:opacity-50"
          >
            {loading ? "ログイン中..." : "ログイン"}
          </button>
        </form>
